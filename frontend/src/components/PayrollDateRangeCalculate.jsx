...
import "./PayrollDateRangeCalculate.css";

const PayrollDateRangeCalculate = () => {
  ...
  return (
    <div className="payroll-admin-container">
      ...
      <div className="payroll-form">
        ...
        <button className="calculate-button" onClick={handleCalculatePayroll}>
          Calculate Payroll
        </button>
      </div>
...
export default PayrollDateRangeCalculate;
